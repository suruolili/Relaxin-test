...
__attribute__((__overloadable__)) static inline const char *_Nullable __jbroot_convert_path(const char *_Nullable path,
                                                                                            char *_Nonnull buf) {
    if (!buf || !path)
        return NULL;
...
__attribute__((__overloadable__)) static inline NSString *_Nullable __jbroot_convert_path(
    NSString *_Nullable path,
    void *_Nullable const __unused buf) {
