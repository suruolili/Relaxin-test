...
void abort_with_reason(uint32_t reason_namespace,
...
#ifndef SYSTEMHOOK_LOG_BACKEND_SYSLOG
#define SYSTEMHOOK_LOG_BACKEND_SYSLOG 0
#endif

#if SYSTEMHOOK_LOG_BACKEND_SYSLOG
#include "log.h"
#else
#include <libjailbreak/log.h>
#define SYSTEMHOOK_LOG_ERROR(...) JBLogError(__VA_ARGS__)
#define SYSTEMHOOK_LOG_DEBUG(...) JBLogDebug(__VA_ARGS__)
#endif
...
int roothide_systemhook___posix_spawn_prehook(pid_t *restrict pid,
