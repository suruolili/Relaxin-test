...
extern bool ORIG(_ZN5dyld46Loader18expandAtLoaderPathERNS_12RuntimeStateEPKcRKNS0_11LoadOptionsEPKS0_bPc)(
    RuntimeState *state,
    const char *loadPath,
    ...
    bool fromLCRPATH,
    char fixedPath[]);
bool HOOK(_ZN5dyld46Loader18expandAtLoaderPathERNS_12RuntimeStateEPKcRKNS0_11LoadOptionsEPKS0_bPc)(
    RuntimeState *state,
    const char *loadPath,
    const LoadOptions *options,
    const Loader *ldr,
    ...
    char fixedPath[]) {
    bool ret = ORIG(
        _ZN5dyld46Loader18expandAtLoaderPathERNS_12RuntimeStateEPKcRKNS0_11LoadOptionsEPKS0_bPc)(state,
                                                                                                 loadPath,
                                                                                                 options,
                                                                                                 ldr,
                                                                                                 fromLCRPATH,
