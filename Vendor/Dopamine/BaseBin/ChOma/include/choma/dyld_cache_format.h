...
struct dyld_cache_accelerator_info {
    ...
    uint32_t
        depListOffset;     // offset into this chunk to start of 16-bit array of dependencies (0x8000 bit set if upward)
...
static const char *cryptexPrefixes[] = {"/System/Volumes/Preboot/Cryptexes/OS/",
